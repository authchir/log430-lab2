...
public class DeliveryReader extends LineOfTextFileReader {
	 ...
	 * List of deliveries.
	 */
	private ArrayList<Delivery> listOfDeliveries = new ArrayList<Delivery>();
	 ...
	 */
	public ArrayList<Delivery> getDeliveryList(String inputFile) {
	...
	public void setListOfDeliveries(ArrayList<Delivery> listOfDeliveries) {
		this.listOfDeliveries = listOfDeliveries;
	}

	public ArrayList<Delivery> getListOfDeliveries() {
