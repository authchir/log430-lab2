...
public class DriverReader extends LineOfTextFileReader {
	 ...
	 * The list of drivers.
	 */
	private ArrayList<Driver> listOfDrivers = new ArrayList<Driver>();
	 ...
	 */
	public ArrayList<Driver> readDriverListFromFile(String inputFile) {
		...
		ArrayList<Driver> listObject = new ArrayList<Driver>();
		...
		while (!done) {
			...
			default:
				...
				if (colonIndex != -1) {
					...
					int estimatedDuration = Integer.parseInt(token.substring(colonIndex+1));
